    ...
    class Yuki_Logo_Element extends Element
    {
        ...
        public function getControls()
        {
            return [ ( new Tabs() )->setActiveTab( 'content' )->addTab( 'content', __( 'Content', 'yuki' ), [
                ...
                ( new Slider( $this->getSlug( 'height' ) ) )->setLabel( __( 'Logo Height', 'yuki' ) )->enableResponsive()->asyncCss( ".{$this->slug}", [
                '--logo-max-height' => 'value',
            ] )->setMin( 0 )->setMax( 300 )->setDefaultUnit( 'px' )->setDefaultValue( $this->getDefaultSetting( 'height', '40px' ) ),
                ( new Slider( $this->getSlug( 'spacing' ) ) )->setLabel( __( 'Logo Spacing', 'yuki' ) )->enableResponsive()->asyncCss( ".{$this->slug}", [
                '--logo-spacing' => 'value',
                ...
                ( new Separator() )->dashedStyle(),
                ( new Radio( $this->getSlug( 'content_alignment' ) ) )->setLabel( __( 'Content Alignment', 'yuki' ) )->enableResponsive()->asyncCss( ".{$this->slug}", [
                'text-align' => 'value',
